...
try:
    from bim_authoring.http import register_bim_authoring_routes
    register_bim_authoring_routes(app)
    print("Biblioteca BIM registrada: /api/bim-authoring/recipes")
except Exception as _e:
    print(f"Falha ao registrar biblioteca BIM: {_e}")
